...
const Datenschutz = () => (
  <div>
    ...
    <div className="wrapper">
      ...
      bestimmter Tools verhindern. Detaillierte Informationen zu diesen Tools
      und über Ihre Widerspruchsmöglichkeiten finden Sie in der folgenden
      Datenschutzerklärung.
      <br />
      <br />
      ...
      Rechtsbehelfe. Eine Liste der Datenschutzbeauftragten sowie deren
      Kontaktdaten können folgendem Link entnommen werden:
      https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html
      (Deutschland) und https://www.dsb.gv.at/kontakt (Österreich).
      <br />
      <br />
      ...
      verlangen. Wenn wir Ihre personenbezogenen Daten nicht mehr benötigen, Sie
      ...
      eingeschränkt haben, dürfen diese Daten – von ihrer Speicherung abgesehen
      ...
      <br />
      <br />
      Die Internetseiten verwenden teilweise sogenannte Cookies. Cookies richten
      ...
      erfolgt nicht. Grundlage für die Datenverarbeitung ist Art. 6 Abs. 1 lit.
      ...
      <br />
      <br />
      Statt einer direkten Registrierung auf unserer Website können Sie sich mit
      ...
      können Sie sich mit Ihren Nutzungsdaten anmelden. Dadurch wird Ihr
      Facebook-Profil mit unserer Website bzw. unseren Diensten verknüpft. Durch
      ...
      Datenverarbeitungsvorgänge erfolgen auf Grundlage Ihrer Einwilligung (Art.
      6 Abs. 1 lit. a DSGVO). Diese Einwilligung können Sie jederzeit mit
      Wirkung für die Zukunft widerrufen.
      <br />
      <br />
      Weitere Informationen finden Sie in den Facebook-Nutzungsbedingungen und
      den Facebook-Datenschutzbestimmungen. Diese finden Sie unter:
      ...
      sowohl die Information, dass Sie für einen Inhalt +1 gegeben haben, als
      auch Informationen über die Seite, die Sie beim Klicken auf +1 angesehen
      ...
      haben. Die Identität Ihres Google-Profils kann Nutzern angezeigt werden,
      ...
      wie etwa Publisher, Inserenten oder verbundene Websites. Die Verwendung
      des Google+-Plugins erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.
      ...
      sowie deren Nutzung durch Instagram erhalten.Die Verwendung des
      ...
      Google DoubleClick. Anbieter ist die Google Ireland Limited („Google“),
      ...
      diesem Zweck Ihren Web- und App-Browserverlauf mit Ihrem Google-Konto. Auf
      diese Weise können auf jedem Endgerät auf dem Sie sich mit Ihrem
      ...
      widersprechen, indem Sie personalisierte Werbung deaktivieren; folgen Sie
      hierzu diesem Link: https://www.google.com/settings/ads/onweb/.
      <br />
      <br />
      ...
      widersprochen haben) beruht die Erfassung der Daten auf Art. 6 Abs. 1 lit.
      f DSGVO. Das berechtigte Interesse ergibt sich daraus, dass der
      ...
      1600 Amphitheatre Parkway, Mountain View, CA 94043, USA. Google AdSense
      ...
      (unsichtbare Grafiken). Durch diese Web Beacons können Informationen wie
      der Besucherverkehr auf diesen Seiten ausgewertet werden. Die durch
      Cookies und Web Beacons erzeugten Informationen über die Benutzung dieser
      Website (einschließlich Ihrer IP-Adresse) und Auslieferung von
      Werbeformaten werden an einen Server von Google in den USA übertragen und
      dort gespeichert. Diese Informationen können von Google an Vertragspartner
      von Google weiter gegeben werden. Google wird Ihre IP-Adresse jedoch nicht
      mit anderen von Ihnen gespeicherten Daten zusammenführen. Die Speicherung
      von AdSense-Cookies erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.
      Der Websitebetreiber hat ein berechtigtes Interesse an der Analyse des
      Nutzerverhaltens, um sowohl sein Webangebot als auch seine Werbung zu
      optimieren. Sie können die Installation der Cookies durch eine
      ...
      identifizieren lassen. Wenn Sie nicht am Tracking teilnehmen möchten,
      ...
      Tracking-Tools erfolgen auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
      Websitebetreiber hat ein berechtigtes Interesse an der Analyse des
      Nutzerverhaltens, um sowohl sein Webangebot als auch seine Werbung zu
      optimieren.
      <br />
      ...
      dass die Erhebung, Verarbeitung und Nutzung Ihrer Daten in Übereinstimmung
      ...
      Rechtsgrundlage hierfür ist § 26 BDSG-neu nach deutschem Recht (Anbahnung
      eines Beschäftigungsverhältnisses), Art. 6 Abs. 1 lit. b DSGVO (allgemeine
      ...
      ablehnen, Ihre Bewerbung zurückziehen, Ihre Einwilligung zur
      Datenverarbeitung widerrufen oder uns zur Löschung der Daten auffordern,
      werden die von Ihnen übermittelten Daten inkl. ggf. verbleibender
      physischer Bewerbungsunterlagen für maximal 6 Monate nach Abschluss des
      ...
      <br />
      <br />
      Nach Ablauf der Aufbewahrungsfrist werden die Daten gelöscht, sofern keine
      ...
      sein wird (z. B. aufgrund eines drohenden oder anhängigen Rechtsstreits),
      findet eine Löschung erst statt, wenn die Daten gegenstandslos geworden
      ...
      Amazon.de eingebunden, an denen wir über 23 / 27 Werbekostenerstattung
      Geld verdienen können. Amazon setzt dazu Cookies ein, um die Herkunft der
      Bestellungen nachvollziehen zu können. Dadurch kann Amazon erkennen, dass
      Sie den Partnerlink auf unserer Website geklickt haben. Die Speicherung
      von „Amazon-Cookies“ erfolgt auf Grundlage von Art. 6 lit. f DSGVO. Der
      Websitebetreiber hat hieran ein berechtigtes Interesse, da nur durch die
      Cookies die Höhe seiner Affiliate-Vergütung feststellbar ist. Weitere
      Informationen zur Datennutzung durch Amazon erhalten Sie in der
      ...
      <br />
      <br />
      Soziale Netzwerke wie Facebook, Google+ etc. können Ihr Nutzerverhalten in
      der Regel umfassend analysieren, wenn Sie deren Webseite oder eine
      Webseite mit integrierten Social-Media-Inhalten (z. B. Like-Buttons oder
      ...
      Social-Media-Präsenz angezeigt werden. Sofern Sie über einen Account beim
      jeweiligen sozialen Netzwerk verfügen, kann die interessenbezogene Werbung
      auf allen Geräten angezeigt werden, auf denen Sie eingeloggt sind oder
      eingeloggt waren.
      <br />
      <br />
      Bitte beachten Sie außerdem, dass wir nicht alle Verarbeitungsprozesse auf
      den Social-Media-Portalen nachvollziehen können. Je nach Anbieter können
      ...
      <br />
      <br />
      Unsere Social-Media-Auftritte sollen eine möglichst umfassende Präsenz im
      ...
      <br />
      <br />
      Bitte beachten Sie, dass wir trotz der gemeinsamen Verantwortlichkeit mit
      den Social-Media-Portal-Betreibern nicht vollumfänglich Einfluss auf die
      Datenverarbeitungsvorgänge der Social-Media-Portale haben. Unsere
      ...
      entfällt. Gespeicherte Cookies verbleiben auf Ihrem Endgerät, bis Sie sie
      löschen. Zwingende gesetzliche Bestimmungen – insb. Aufbewahrungsfristen –
      bleiben unberührt.
      <br />
      <br />
      ...
      Betreibern der sozialen Netzwerke (z. B. in deren Datenschutzerklärung,
      siehe unten).
      <br />
      <br />
      ...
      <br />
      <br />
      Wir verfügen über ein Profil bei Facebook. Anbieter ist die Facebook Inc.,
      1 Hacker Way, Menlo Park, California 94025, USA. Facebook verfügt über
      eine Zertifizierung nach dem EU-US-Privacy-Shield.
      <br />
      <br />
      ...
      für welche Datenverarbeitungsvorgänge wir bzw. Facebook verantwortlich
      ist, wenn Sie unsere Facebook-Page besuchen. Diese Vereinbarung können Sie
      ...
      ein:https://www.facebook.com/settings?tab=ads.
      <br />
      <br />
      ...
      <br />
      <br />
      Wir verfügen über ein Profil bei Google+. Anbieter ist die Google Ireland
      Limited („Google“), Gordon House, Barrow Street, Dublin 4, Irland. Google
      ...
      <br />
      <br />
      Wir nutzen den Kurznachrichtendienst Twitter. Anbieter ist die Twitter
      Inc., 1355 Market Street, Suite 900, San Francisco, CA 94103, USA. Twitter
      verfügt über eine Zertifizierung nach dem EU-US-Privacy-Shield.
      <br />
      <br />
      ‍Sie können Ihre Twitter-Datenschutzeinstellungen selbstständig in Ihrem
      Nutzer-Account anpassen. Klicken Sie hierzu auf folgenden Link und loggen
      Sie sich ein: https://twitter.com/personalization.
      <br />
      <br />
      ...
      <br />
      <br />
      Wir verfügen über ein Profil bei Instagram. Anbieter ist die Instagram
      Inc., 1601 Willow Road, Menlo Park, CA, 94025, USA. Details zu deren
